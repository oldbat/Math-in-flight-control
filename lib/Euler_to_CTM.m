...
C(2,1) = cos_theta * sin_psi;
C(3,1) = -sin_theta;
C(1,2) = -cos_phi * sin_psi + sin_phi * sin_theta * cos_psi;
C(2,2) = cos_phi * cos_psi + sin_phi * sin_theta * sin_psi;
C(3,2) = sin_phi * cos_theta;
C(1,3) = sin_phi * sin_psi + cos_phi * sin_theta * cos_psi;
C(2,3) = -sin_phi * cos_psi + cos_phi * sin_theta * sin_psi;
